  ...
  render () {
    return (
      <div className="center">
        <ButtonToolbar>
          <button className="btn btn-default" onClick={this.props.playButton }>playButton </button>
          <button className="btn btn-default" onClick={this.props.pauseButton}>pauseButton</button>
          ...
          <button className="btn btn-default" onClick={this.props.medium       }>medium       </button>
